...
//TODO add generate manually ?
//TODO: check config in examples
...
function Home() {
    async function getSchema() {
        const {data, errors} = await fetch('http://dev-hdts.herokuapp.com/v1/graphql', {
            method: 'POST',
            headers: {
        ...
        <Layout
            ...
            <header className={clsx('hero hero--primary', styles.heroBanner)}>
                <div className="container">
                    <button onClick={() => getSchema()}>Get Gq Schema</button>
